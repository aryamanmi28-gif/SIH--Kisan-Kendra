...
export const FAQ_DATABASE = [
  ...
  {
    id: 'sms_notification',
    category: 'Notifications & SMS Alerts',
    keywords: ['sms', 'notification', 'alert', 'message', 'text', 'confirm', 'slot sms', 'queue sms', 'एसएमएस', 'मैसेज', 'सूचना', 'टोकन मैसेज', 'ಸಂದೇಶ', 'எஸ்எம்எஸ்', 'మెసేజ్'],
    question: {
      en: 'How do I receive SMS and app notifications for my booking and queue?',
      hi: 'मैं अपनी बुकिंग और कतार के लिए एसएमएस और ऐप नोटिफिकेशन कैसे प्राप्त करूं?',
      kn: 'ನನ್ನ ಬುಕಿಂಗ್ ಮತ್ತು ಸರದಿಗೆ SMS ಮತ್ತು ಅಪ್ಲಿಕೇಶನ್ ಅಧಿಸೂಚನೆ ಪಡೆಯುವುದು ಹೇಗೆ?',
      ta: 'என் முன்பதிவு மற்றும் வரிசைக்கு SMS மற்றும் ஆப் அறிவிப்புகளை எவ்வாறு பெறுவது?',
      te: 'నా బుకింగ్ మరియు క్యూ కోసం SMS మరియు యాప్ నోటిఫికేషన్‌లను ఎలా పొందాలి?'
    },
    answer: {
      en: '📱 SMS Notifications are automatically generated when you book a slot!\nWhen you book a slot or click "Send SMS Alert" on your Booking Slip or Live Queue Tracker, an SMS is sent to your registered mobile number containing:\n1. Confirmed Booking Reference Code (e.g. BK-5DB136DA)\n2. Slot Date & Time Window at your Mandi Centre\n3. Queue ahead count & Token info.\n\nYou can trigger SMS notifications anytime from your booking confirmation page or live queue tracker.',
      hi: '📱 स्लॉट बुक करते ही स्वचालित रूप से एसएमएस नोटिफिकेशन जनरेट हो जाता है!\nजब आप स्लॉट बुक करते हैं या अपनी बुकिंग स्लिप / लाइव कतार पर "एसएमएस भेजें" पर क्लिक करते हैं, तो आपके पंजीकृत मोबाइल पर एसएमएस भेजा जाता है जिसमें शामिल होता है:\n1. कन्फर्म बुकिंग रेफरेंस कोड\n2. स्लॉट की तिथि और समय\n3. आगे की कतार की संख्या व टोकन जानकारी।',
      kn: '📱 ನೀವು ಸ್ಲಾಟ್ ಬುಕ್ ಮಾಡಿದಾಗ SMS ಅಧಿಸೂಚನೆ ಸ್ವಯಂಚಾಲಿತವಾಗಿ ಕಳುಹಿಸಲ್ಪಡುತ್ತದೆ! ಬುಕಿಂಗ್ ಸ್ಲಿಪ್‌ನಲ್ಲಿ "Send SMS Alert" ಕ್ಲಿಕ್ ಮಾಡಿ ಪಡೆಯಬಹುದು.',
      ta: '📱 ஸ்ಲಾட் முன்பதிவு செய்தவுடன் SMS அறிவிப்பு தானாகவே உருவாக்கப்படும்! முன்பதிவு சீட்டில் "Send SMS Alert" கிளிக் செய்து பெறலாம்.',
      te: '📱 మీరు స్లాట్ బుక్ చేయగానే SMS నోటిఫికేషన్ ఆటోమేటిక్‌గా వస్తుంది! బుకింగ్ స్లిప్‌లో "Send SMS Alert" పై క్లిక్ చేసి కూడా పొందవచ్చు.'
    }
  }
]
